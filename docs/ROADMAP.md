...
- `TD-UI-001` — fix одного replay data-reveal clock реализован и покрыт component
  regression test; долг закрывается только после browser visual acceptance
  на 1x–100x и 20 000 свечей.
