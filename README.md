...
- Stop loss и take profit задаются в процентах от цены исполнения. При
  ...
  stop-first.
- Position size трактуется как число ценовых единиц, комиссия — как сумма на
  одно исполнение, relative slippage — в basis points, swap — сумма на позицию
  за пересечённый календарный день.
