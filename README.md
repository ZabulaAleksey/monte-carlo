...
Regression-исправление мигания replay-графика реализовано и автоматизированно
проверено; production browser acceptance на 1x–100x и 20 000 свечей пройден,
поэтому `TD-UI-001` закрыт.
