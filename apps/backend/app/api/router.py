...
from app.api.v1.tester_routes import router as tester_router

api_router = APIRouter()
api_router.include_router(v1_router, prefix="/api/v1")
api_router.include_router(backtest_router, prefix="/api/v1")
api_router.include_router(database_router, prefix="/api/v1")
...
api_router.include_router(tester_router, prefix="/api/v1")
